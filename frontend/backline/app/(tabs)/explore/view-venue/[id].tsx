...
import { renderBioWithLinks, profileStyles } from '../../profile/index';
        ...
        const load = async () => {
            try {
                ...
                const following = await followService.checkFollowing(
                    followerType, 'VENUE', id!, followerBandId, followerVenueId
                );
                setIsFollowing(following);
            } catch (e) {
                console.error('ViewVenueScreen load error:', e);
            } finally {
                setLoading(false);
            }
        };

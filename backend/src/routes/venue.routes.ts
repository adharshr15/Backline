...
import { getVenues, getVenueById, updateVenue, deleteVenue, createVenue, respondToShowInvite, getMyShowInvites } from '../controllers/venue.controller'
import { leaveVenue } from '../controllers/membership.controller'
...
router.delete("/:id/representatives/me", leaveVenue as RequestHandler)
